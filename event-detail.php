...
mysqli_set_charset($db,'utf8');
	...
	$recodSet = mysqli_query($db,'SELECT * FROM event ORDER BY id DESC LIMIT 3');
?>
...
<div class="wrap"><div class="shousai-all">
	...
	<?php endif;?>
		...
		<div class="shousai-more">
			<p class="shousai-more-p">新着イベント</p>
			<ul><?php while($table = mysqli_fetch_assoc($recodSet)){?>
				<li class="<?php echo htmlspecialchars($table['class'],ENT_QUOTES,'UTF-8');?>">

				<a href="event-detail.php?id=<?php echo htmlspecialchars($table['id'],ENT_QUOTES,'UTF-8');?>">
...
<p><a href="event.php" class="shousai-back">EVENT一覧に戻る</a></p>
